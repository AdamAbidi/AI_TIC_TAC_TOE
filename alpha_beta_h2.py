...
class Game:
    ...
    def draw_board(self):
        ...
        start = time.time()
        (m, qx, qy) = self.max_alpha_beta(-9,9,'X')
    ...
    def play(self):
        ...
        (m, px, py) = self.max_alpha_beta(-9,9,'O')
        ...
        start = time.time()
        (m, qx0, qy0) = self.max_alpha_beta(-9,9,'X')
        end = time.time()
        print('Evaluation time: {}s'.format(round(end - start, 7)))
        ...
        start = time.time()
        (m, qx, qy) = self.min_alpha_beta(-9,9,'X')
        end = time.time()
        print('Evaluation time: {}s'.format(round(end - start, 7)))
        print('Recommended move: X = {}, Y = {}'.format(qx, qy))
